          ...
          <div className="relative flex-1 flex flex-col bg-[#FEF9C3] rounded-xl border border-yellow-200 shadow-[0_8px_30px_rgba(234,179,8,0.12)]">
            ...
            <div className="p-5 flex-1 flex flex-col">
              <textarea
                ...
                className="w-full bg-transparent border-0 outline-none focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 px-0 py-0 resize-none flex-1 min-h-[240px] text-[20px] font-semibold text-yellow-950/90 placeholder:text-yellow-600/50 leading-[28px] font-handwriting pt-[2px]"
                style={{
