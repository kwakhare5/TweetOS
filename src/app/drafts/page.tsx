  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center space-y-8 text-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight mb-2">Drafts Archive</h1>
          <p className="text-muted-foreground">Manage, search, and schedule your historic and generated drafts.</p>
        </div>
        ...
        <div className="relative w-full max-w-md bg-card border rounded-xl p-8 shadow-sm rotate-[0.3deg] flex flex-col items-center gap-4">
          ...
          <p className="text-sm text-slate-500 max-w-xs leading-relaxed">
            The Drafts Archive is currently being compiled. Soon you will be able to synchronize scheduled posts here.
          </p>
        </div>
      </div>
    </motion.div>
