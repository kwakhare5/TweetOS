...
interface TailoredOutputProps {
  tailoredTweet: string
  hooks: string[]
  factCheck: string
  activeTone: "dev" | "personal" | "shitpost" | "auto"
  isTailoring: boolean
  copiedDraft: boolean
  copiedGrok: boolean
  handleTailor: (tone: "dev" | "personal" | "shitpost" | "auto") => void
  handleCopyDraft: () => void
  handleCopyGrok: () => void
}
