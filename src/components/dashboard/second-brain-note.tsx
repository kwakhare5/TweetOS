...
export function SecondBrainNote({ initialText, onSave }: SecondBrainNoteProps) {
 ...
 <div className="size-2.5 rounded-full bg-red-400 border border-red-500/20 shadow-sm " />
 <div className="size-2.5 rounded-full bg-yellow-400 border border-yellow-500/20 shadow-sm " />
 <div className="size-2.5 rounded-full bg-green-400 border border-green-500/20 shadow-sm " />
 </div>
