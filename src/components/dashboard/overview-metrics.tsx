      ...
      <div className="grid gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
        ...
        <Card className="group">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Activity className="h-4 w-4 text-muted-foreground transition-all duration-300 group-hover:scale-125 group-hover:text-primary" />
          </CardHeader>
          <CardContent>
        ...
        <Card className="group">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <MousePointerClick className="h-4 w-4 text-muted-foreground transition-all duration-300 group-hover:scale-125 group-hover:text-primary" />
          </CardHeader>
          <CardContent>
        ...
        <Card className="group">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <ArrowUpRight className="h-4 w-4 text-muted-foreground transition-all duration-300 group-hover:scale-125 group-hover:text-primary" />
          </CardHeader>
          <CardContent>
