...
const ActionIcon = ({ d, className }: { d: string, className?: string }) => (
 <svg viewBox="0 0 24 24" aria-hidden="true" className={cn("w-[18.75px] h-[18.75px] fill-current", className)}>
 <g><path d={d}></path></g>
 </svg>
)
...
export function TweetActionFooter({
 ...
 onClick={onReply}
 aria-label="Reply"
 className="group flex items-center gap-1 focus-visible:outline-hidden cursor-pointer bg-transparent border-0 p-0"
 >
 <div className="p-2 -m-2 rounded-full group- group-] ">
 ...
 {replies !== undefined && <span className="px-1 group-] ">{replies}</span>}
 </button>
 ...
 aria-label="Retweet"
 className={cn(
 "group flex items-center gap-1 cursor-pointer bg-transparent border-0 p-0 focus-visible:outline-hidden",
 hasRetweeted ? "text-[#00ba7c]" : ""
 )}
 >
 <div className="p-2 -m-2 rounded-full group- group-] ">
 ...
 {retweets !== undefined && <span className="px-1 group-] ">{retweets}</span>}
 </button>
 ...
 {likes !== undefined && <span className="px-1 group-] ">{likes}</span>}
 </button>
 ...
 {views !== undefined && <span className="px-1 group-] ">{views}</span>}
 </button>
 </div>
 ...
 type="button"
 aria-label="Bookmark"
 className="group flex items-center justify-center focus-visible:outline-hidden cursor-pointer bg-transparent border-0 p-0"
 >
 <div className="p-2 -m-2 rounded-full group- group-] ">
