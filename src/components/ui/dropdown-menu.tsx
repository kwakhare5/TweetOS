    ...
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            // Layout
            "z-50 min-w-40 max-h-[--available-height] origin-[--transform-origin]",
            // Appearance — visible border + shadow, slight blur tint
            "rounded-lg border border-border bg-card/95 backdrop-blur-sm p-1.5",
...
function DropdownMenuLabel({
  ...
  return (
    <MenuPrimitive.GroupLabel
      ...
      data-inset={inset}
      className={cn(
        "px-2 py-1 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground data-inset:pl-8",
        className
      )}
      {...props}
    />
...
function DropdownMenuItem({
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        // Base layout
        "group/dropdown-menu-item relative flex cursor-pointer items-center gap-2",
        "rounded-md px-2 py-1.5 text-sm outline-none select-none",
        // Hover/focus
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "relative flex cursor-default items-center gap-2 rounded-md py-1.5 pr-8 pl-2 text-sm",
