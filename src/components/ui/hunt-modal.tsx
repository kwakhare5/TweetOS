  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm p-4">
      <motion.div
        ...
        className="relative w-full max-w-lg bg-background rounded-xl shadow-xl border border-border overflow-hidden"
      >
        {/* Washi tape detail */}
        <div className="absolute top-0 left-0 right-0 h-1.5 bg-yellow-200/40 opacity-70" />
        
        <div className="flex items-center justify-between p-4 border-b border-border">
          <h2 className="font-sans font-medium text-foreground flex items-center gap-2">
            ...
            {step === 1 ? (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className="flex flex-col items-center justify-center gap-3 p-6 bg-card border border-border rounded-xl hover:border-ring/30 hover:shadow-sm hover:scale-[1.02] transition-all active:scale-[0.98] group"
                  >
                    <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary group-hover:scale-110 transition-transform">
                      <Zap size={24} />
                    </div>
                    <div className="text-center">
                      <div className="font-medium text-foreground">Apify Auto ⚡</div>
                      <div className="text-xs text-muted-foreground mt-1">Uses API credits</div>
                    </div>
                  </button>
                  ...
                  <button
                    ...
                    className="flex flex-col items-center justify-center gap-3 p-6 bg-card border border-border rounded-xl hover:border-slate-500/30 hover:shadow-sm hover:scale-[1.02] transition-all active:scale-[0.98] group"
                  >
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-xs text-muted-foreground mt-1">Zero cost, paste in Grok</div>
                    </div>
                  </button>
                </div>
              </motion.div>
              ...
              >
                {type === 'engagement' && (
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2 mb-2">
                      {accounts.map(acc => (
                        <span key={acc} className="inline-flex items-center gap-1 px-2.5 py-1 bg-primary/10 text-primary text-sm rounded-md font-sans">
                          @{acc}
                    ...
                    <div className="relative">
                      <AtSign size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground/60" />
                      <input
                        type="text"
                        ...
                        className="w-full pl-8 pr-3 py-2 bg-card border border-border rounded-lg text-sm text-foreground focus:outline-none focus:border-ring font-sans"
                      />
                    </div>
                  </div>
                )}
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2 mb-2">
                    {keywords.map(kw => (
                      <span key={kw} className="inline-flex items-center gap-1 px-2.5 py-1 bg-card border border-border text-amber-900 text-sm rounded-md font-sans shadow-sm">
                        {kw}
