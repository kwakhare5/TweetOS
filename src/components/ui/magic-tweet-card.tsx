...
import { TweetActionFooter } from "./tweet-action-footer"
...
export const TweetHeader = ({ tweet }: { tweet: EnrichedTweet }) => (
 ...
 target="_blank"
 rel="noreferrer"
 className="text-foreground flex items-center font-medium whitespace-nowrap "
 >
 ...
 <Twitter className="text-muted-foreground size-5 items-start ease-in-out " />
 </a>
 </div>
)
...
export const TweetBody = ({ tweet }: { tweet: EnrichedTweet }) => (
 ...
 className="text-muted-foreground text-[15px] font-normal "
 >
...
export const MagicTweet = ({
 ...
 <div
 className={cn(
 "relative flex h-full w-full max-w-lg flex-col gap-4 overflow-hidden rounded-xl border p-5",
 className
 )}
 {...props}
 >
 ...
 <TweetActionFooter 
 likes={safeTweet.favorite_count || 1240} 
 replies={safeTweet.conversation_count || 32} 
 retweets={450} 
 views={"10.5K"}
 className="mt-0 pt-0 border-t-0 max-w-full"
 />
 </div>
 )
}
